...
(function (OSFAppTelemetry) {
	...
	function initialize(context) {
		...
		var version=appInfo.hostVersion;
		if (!flavor || (!version && flavor.toLowerCase()==="win32")) {
			OSFAriaLogger.AriaLogger.EnableSendingTelemetryWithLegacyAria=false;
		}
		else if (flavor && version) {
			var versionTokens=version.split('.');
			if (flavor.toLowerCase()==="win32" && (versionTokens.length < 3 ||
				(parseInt(versionTokens[0], BASE10) >=MAX_MAJOR_VERSION &&
...
(function (Visio) {
	var _hostName="Visio";
	var _defaultApiSetName="VisioApi";
	var _createPropertyObject=OfficeExtension.BatchApiHelper.createPropertyObject;
	var _createMethodObject=OfficeExtension.BatchApiHelper.createMethodObject;
	var _createIndexerObject=OfficeExtension.BatchApiHelper.createIndexerObject;
	var _createRootServiceObject=OfficeExtension.BatchApiHelper.createRootServiceObject;
		...
		Object.defineProperty(Document.prototype, "onShapeAdded", {
			get: function () {
				...
				if (!this.m_shapeAdded) {
					this.m_shapeAdded=new OfficeExtension.GenericEventHandlers(this.context, this, "ShapeAdded", {
						eventType: 1,
						registerFunc: function () { return _this._RegisterShapeAddedEvent(); },
						unregisterFunc: function () { return _this._UnregisterShapeAddedEvent(); },
						getTargetIdFunc: function () { return ""; },
						eventArgsTransformFunc: function (value) {
							var newArgs={
								type: EventType.shapeAdded,
...
(function (Visio) {
	var RequestContext=(function (_super) {
		...
		function RequestContext(url) {
			...
			_this.m_application=new Visio.Application(_this, OfficeExtension.ObjectPathFactory.createGlobalObjectObjectPath(_this));
			_this._rootObject=_this.m_application;
			return _this;
		}
